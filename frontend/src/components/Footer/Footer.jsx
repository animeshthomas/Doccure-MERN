   ...
   <footer className="pb-16 pt-10">
    <div className="container">
      <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
        <div>
        <img src={logo} alt="" />
        <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>Copyright © {year} developed by Animesh Thomas all rights reserved</p>
        ...
        <div>
          ...
          <ul>
            {quickLinks01.map((item,index)=>
              <li key={index} className='text-[16px] leading-7 font-[400] text-textColor hover:text-primaryColor transition-colors duration-300'>
