          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para"> If you're experiencing any health concerns or
                  need medical advice, don't hesitate to schedule an appointment with one of our experienced doctors
                  today. Your health and well-being are our top priorities.</p>
